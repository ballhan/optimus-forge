...
export function buildMovieRig(k) {
  ...
  for (const s of [-1, 1]) {
    ...
    shell(
      chest,
      [
        [-0.67, 0.135, -s * 0.09, 0.045],
        [-0.4, 0.22, -s * 0.025, 0.1],
        [-0.19, 0.285, s * 0.015, 0.065],
        [-0.05, 0.32, s * 0.04, 0.015],
      ],
      [0, 0, 0.1],
      m.red,
      [0, 0, 0],
    ...
    const cap = shell(
      ...
      [
        [-0.4, 0.3, s * 0.2, -0.15],
        [-0.16, 0.43, s * 0.09, -0.02],
        [0.1, 0.36, -s * 0.07, 0.015],
        [0.34, 0.18, -s * 0.17, -0.09],
        [0.43, 0.06, -s * 0.2, -0.17],
      ],
      [0, 0.035, 0.15],
      m.flame,
      [0, 0, 0],
    ...
    cyl(arm, 0.235, 0.08, [0, 0.38, 0.2], m.red, "z", 0.22, 32);
    torus(arm, 0.238, 0.014, [0, 0.38, 0.247], m.steel);
